/*
 * @Author: yhf 
 * @Date: 2018-10-16 22:16:14 
 * @Last Modified by: yhf
 * @Last Modified time: 2018-10-17 20:33:17
 */
// 这是 main.js 是我们项目的js入口文件

// 1. 导入 Jquery
// import *** from *** 是Es6中导入模块的方式
// 由于 ES6的代码太高级，浏览器无法解析，所以这一行有问题
import $ from 'jquery'
...
// 注意： webpack，默认只能打包处理 JS 类型的文件，无法处理，其他的非js文件
// 如果要处理非js类型的文件，我们需要手动安装合适的第三方 loader 加载器
// 1. 如果想要打包处理 css 文件，需要安装 
// sudo cnpm i style-loader -D
// sudo cnpm i css-loader -D
